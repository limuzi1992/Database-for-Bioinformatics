...
http://localhost/BCHB697/ml1592/ml1592Gene.php
*/
?>
...
if(!empty($connection))
{
		$query = "call Get_Gene(" . '"' . $UniProtKB_Entry. '")';
		//echo $query."<br/>";
...
<body class="body4">
	...
	<p> Get the gene encoding the protein of interest:
	...
	{	
			...
			} else
			{
				...
				echo '<caption style="font-size:22pt"> <b>
					The gene encoding the protein </b>';
