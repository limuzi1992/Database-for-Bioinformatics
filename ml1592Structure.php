...
http://localhost/BCHB697/ml1592/ml1592Structure.php
*/
?>
...
if(!empty($connection))
{
		$query = "call Get_ProteinStructures(" . '"' . $UniProtKB_Entry. '")';
		//echo $query."<br/>";
...
<body class="body4">
	...
	<p>Get structures of the protein of interest by entering the UniProtKB accession number:
	...
	{	
			...
			} else
			{
				...
				echo '<caption style="font-size:22pt"> <b>
					The structures of the protein </b>';
