...
http://localhost/BCHB697/ml1592/ml1592Disease.php
*/
?>
...
if(!empty($connection))
{
		$query = "call Get_Diseases(" . '"' . $UniProtKB_Entry. '")';
		//echo $query."<br/>";
...
<body class="body4">
	...
	<p>Get the diseases in which the protein of interest is involved by entering the UniProtKB accession number:
	...
	{	
			...
			} else
			{
				...
				echo '<caption style="font-size:22pt"> <b>
					The diseases that the protein </b>';
				echo '<b>' . $UniProtKB_Entry . '</b>'; 
				echo '<b> is involved in </b>';
				echo "</caption>";
				echo "<thead>
						<tr>";
